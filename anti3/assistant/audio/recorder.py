"""
Audio Recorder — Captures audio from USB microphone.
"""
...
class AudioRecorder:
    """Record audio from USB microphone using sounddevice."""
    ...
    def stop_recording(self):
        ...
        try:
            ...
            logger.info("Recording saved to %s (%.1fs)", tmp_path, len(audio_data) / SAMPLE_RATE)
            return tmp_path

...
# ──────────────────────────────────────────────
# 2. LLM — TinyLlama 1.1B (Q4_K_M GGUF)
# ──────────────────────────────────────────────
...
if [ -f "$LLM_MODEL" ]; then
    ...
    echo "    This may take several minutes on slow connections."
...
# ──────────────────────────────────────────────
# 3. Whisper Tiny (faster-whisper auto-downloads)
# ──────────────────────────────────────────────

echo "[i] Whisper model: faster-whisper will auto-download"
echo "    the 'tiny' model on first run (~75MB)."
